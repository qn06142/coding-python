...
#include <bits/stdc++.h>
namespace __DEBUG_UTIL__{ using namespace std; void print(const char /**/*x) {cerr << x;} void print(bool x) {cerr << (x ? "T" : "F");}/*
*/void print(char x){cerr <<'\'' << x << '\'';} void print(signed/*##-+++#####*/short int x){cerr <<x;}void print(unsigned short int x)//
{cerr<<x;}void print(signed int x){cerr<< x;} void print(unsigned /*-++++*/int x) {cerr << x;}void print(signed long int x){cerr << x;}/*
*/void print(unsigned long int x){cerr << x;}void print(signed/*-.-++++*/long long int x) {cerr << x;}void print(unsigned long long int/*
*/ x) { cerr << x; } void print(float x){cerr << x;} void print/*-.-++++*/(double x) { cerr << x; } void print(long double x) { cerr <</*
*/x; } void print(string x) {cerr<<'\"'<< x<<'\"';} template/*+-...-----*/<size_t N> void print(bitset<N> x){cerr<<x;}void print(vector/*
*/<bool> v) {  int f = 0; cerr << '{'; for (auto &&i : v/*++#+....-----*/) cerr << (f++ ? "," : "")  <<  (i ? "T" : "F"); cerr << "}";}/*
*/template <typename T> void print (T && x); template /*+.......-------##+++++#+*/<typename T>void print(vector<vector<T>>mat);template/*
*/<typename T, size_t N, size_t M> void print(T (&mat) /*..-....-------+++++*/[N][M]); template <typename F, typename S>void print(pair/*
*/<F, S> x); template <typename T, size_t N>struct Tuple/*-...--+------......+++++++*/; template <typename T>struct Tuple<T,1>;template/*
*/<typename... Args>void print(tuple<Args...> t);/*######+...-+--++++++++++-.....##+#+++#################################################
######+++#+##+###++++++###+++#++##+++++#++++++#########+....--+#---+++#+----#+++#-.-#++######################++##########################
######+++++#++++++++++##+#++++++++++++++++++##########--..-----.-.----++++++++++++++-++#++###############################################
#####+#++++++++++++++++++++--++++++++++###############...---......-+-------+-++++++++#...............+###################################
####++++++++++++--+++-+++++----++++#################+-...-.......-.....++--+--++++++#++............---------#############################
