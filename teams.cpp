...
*/void print(vector<vector<T>> mat);/**/template <typename T, size_t n, size_t M>/*##########################++--++++++++*/void print(T (&mat)[n][M]);/**/template <typename F, typename a>/**/void print(pair<F, a> x);/*##########
...
*/cerr << setw(2) << left << f++, print(i), cerr << "\n";/**/}/*####################++++++#########--------++++++++++++*/cerr << "~~~~~\n";/**/}/**/template <typename F, typename a>/**/void print(pair<F, a> x)/**/{/*############
...
int main() {
    ...
    for (int u = 1; u <= n; u++) {
        for (int v = 1; v <= n; v++) {
            if (u != v && b[u] >= b[v]) {
                pairs.push_back({u, v, b[u] - b[v]});
            }
        }
    }

    sort(pairs.begin(), pairs.end(), [](const stor& x, const stor& y) {
    ...
    for (const auto& pair : pairs) {
        ...
        for (int k = 1; k <= n; ++k) {
            ...
            for (int d = 0; d <= 2 * sum; ++d) {
                ...
                if (b[k] <= b[u] && d + s <= 2 * sum) ndp[d + s] = true;
                if (b[k] <= b[v] && d - s >= 0)     ndp[d - s] = true;
            }
            dp = ndp;
        }
