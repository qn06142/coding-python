...
def generate_test_case(max_length=200):
    # Randomly choose the length of the string within the allowed range
    length = random.randint(1, max_length)
    
    # Generate a random string of the chosen length using lowercase letters
