...
int gethashf(int l, int r) {
    return (hashf[r] - hashf[l - 1] + mod) * baspi[l - 1] % mod;
}
int gethashr(int l, int r) {
    return (hashb[l] - hashb[r + 1] + mod) * baspi[n - r] % mod;
}
...
signed main() {
    ...
    while(q--) {
        ...
        cin >> l >> r;
        debug(l, r);
        cout << diff[r][r] - diff[r][l - 1] - diff[l - 1][r] + diff[l - 1][l - 1] << '\n';
    }
}