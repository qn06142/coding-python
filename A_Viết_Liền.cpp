...
int a[(int) 2e5 + 5];
int pref[(int) 2e5 + 5], len[(int) 2e5 + 5];
const int pow10[] = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000, 100000000000, 1000000000000, 10000000000000, 100000000000000};
...
signed main() {
    ...
    for(int i = 1; i <= n; i++) {
        ans += a[i] * (i - 1);
        ans += (pref[i - 1]) * binpow(10, len[i], mod) % mod;
        ans %= mod;
    }
