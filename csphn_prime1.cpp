...
long long solve2(int sum) {
    long long best = -1;
    int l = 0, r = upper_bound(primes.begin(), primes.end(), sum) - primes.begin() - 1;
    while (l <= r) {
        int p = primes[l];
        int q = primes[r];
        int s = p + q;
...
int main() {
    ...
    if (k == 3) {
        ...
        if (n % 2 == 0) {
            long long sub = solve2(n - 2);
            if (sub > 0) cout << (long long)2 * sub;
            else cout << -1;
        } else {
            cout << -1;
        }
    ...
    if (k == 4) {
        ...
        if (n % 2 == 1 && n >= 5) {
            long long sub = solve2(n - 5);
            if (sub > 0) cout << (long long)2 * 3 * sub;
            else cout << -1;
        } else {
            cout << -1;
        }
