...
def generate_test_case(max_bits=10, max_val=1000000, t=None):
    """
    Generates a random test case as a string.

    Parameters:
    - max_bits: Maximum number of bits (i.e., max value of b)
    - max_val: Maximum value of any element in the array
    - t: Either 1 (submask sum) or 2 (supermask sum). If None, it is random.

    Returns:
    - str: Test case as a multiline string
    """
    b = random.randint(1, max_bits)
    n = random.randint(1, (1 << b) - 1)
...
def main():
    executable1 = './A_Sum_Over_Subsets1'
    executable2 = './A_Sum_Over_Subsets'
