...
long long calcinc(const vector<int>& a) {
...
int main() {
    ...
    for(pair<int, int> i:cnt) {
        add(ans, binpow(2, i.second, MOD) - 1);
    }
    long long increasing = calcinc(a);

    vector<int> reva = a;
    reverse(reva.begin(), reva.end());
    long long decreasing = calcinc(reva);
    cout << (increasing + decreasing + 1 - ans + MOD) % MOD;
}
