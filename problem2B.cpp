...
int main() {
    ...
    while (T--) {
        ...
        while (cnt.find(remainder) == cnt.end()) {
            cnt[remainder] = pos;
            remainder *= 10;
        ...
        int cycle_start = cnt[remainder];  
        int cycle_length = pos - cycle_start;  
        ...
        if (k <= cycle_start) {
            ...
            int cycle_position = (k - cycle_start - 1) % cycle_length;
            cout << digits[cycle_start + cycle_position] << '\n';
        }
    }
