...
def generate_test_case():
    return ' '.join(str(random.randint(1, 100)) for i in range(0, 3))
...
def run_program_py(executable, input_data):
    ...
    return stdout.decode().strip()
def main():
    executable1 = './csphn_partkx1'
    executable2 = './csphn_partkx'
    executable3 = './csphn_partkx2'
    tests = 0
    while True:
        while True:
            try:
        ...
        output3 = run_program(executable3, test_case)
        tests += 1
