...
def generate_test_case(n = 5):
    """
    Generates a random tree with n nodes and returns
    the test-case as a single string:
      - First line: n
      - Next n-1 lines: edges u v
    """
    # Create a random spanning tree via the "random parent" method
